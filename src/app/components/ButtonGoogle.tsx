...
type ButtonGoogle = React.ButtonHTMLAttributes<HTMLButtonElement> & {
  loading?: boolean;
  callbackUrl?: string; // a dónde ir después del login
};
...
export default function GoogleSignInButton({
  ...
  async function handleClick(e: React.MouseEvent<HTMLButtonElement>) {
    try {
      setLoading(true);
      // si el caller pasó onClick, lo ejecutamos primero
      onClick?.(e);
      // dispara NextAuth Google
